...
# hurdle mixto, multinivel, espacial, tipologías) usando el motor 04_engine.R.
...
equidad_subseccion(largo, blq, dirb)
...
modelo_descomposicion(panel, blq, dirb)
espacial_bloque(blq, dirb)
red_servicio(est, blq, dirb)
